...
@section('content')
            ...
            <div class="single-slider single-slider-book1 bg-img" style="background-image: url(assets/img/slider/3.jpg)">
                <div class="container">
                    <div class="slider-animation slider-content-book fadeinup-animated">
                        <h1 class="animated"><span>BVETCI</span> is</h1>
            ...
            <div class="container-fluid">
                ...
                <div class="best-product-style">
                    <div class="product-tab-list2 text-center mb-95 nav product-menu-mrg" role="tablist">
                        <a class="active" href="#home6" data-bs-toggle="tab" role="tab">
                            <h4>Fiction </h4>
                        </a>
                            ...
                            <div class="custom-row">
                                <div class="custom-col-5 custom-col-style mb-95">
                                    <div class="product-wrapper">
                                        ...
                                        <div class="product-content-2 text-center">
                                            <h4><a href="product-details.html">World At War Vol2</a></h4>
                                ...
                                <div class="custom-col-5 custom-col-style mb-95">
                                    <div class="product-wrapper">
                                        ...
                                        <div class="product-content-2 text-center">
                                            <h4><a href="product-details.html">Learn With Arif</a></h4>
                                            <span>By: Arif Khan</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="custom-col-5 custom-col-style mb-95">
                                    <div class="product-wrapper">
                                        ...
                                        <div class="product-content-2 text-center">
                                            <h4><a href="product-details.html">Tour Gide for Africa </a></h4>
                                ...
                                <div class="custom-col-5 custom-col-style mb-95">
                                    <div class="product-wrapper">
                                        ...
                                        <div class="product-content-2 text-center">
                                            <h4><a href="#">History of Moon</a></h4>
                                ...
                                <div class="custom-col-5 custom-col-style mb-95">
                                    <div class="product-wrapper">
                                        ...
                                        <div class="product-content-2 text-center">
                                            <h4><a href="#">Best Freelancing Guide</a></h4>
                                ...
                                <div class="custom-col-5 custom-col-style mb-95">
                                    <div class="product-wrapper">
                                        ...
                                        <div class="product-content-2 text-center">
                                            <h4><a href="#">We Are Going Down</a></h4>
    ...
    <div class="testimonials-area bg-img pt-145 pb-160" style="background-image: url(assets/img/bg/2.jpg)">
        <div class="container">
    ...
    <div class="discount-area pr-205 gray-bg-4 pt-115 pb-90">
        <div class="discount-left text-center">
            <img class="tilter" src="assets/img/product/book/1.png" alt="">
                        ...
                        <div class="new-top-product">
                            <div class="new-top-wrapper mb-50">
                                <div class="new-top-img">
                                    <a href="#"><img src="assets/img/product/book/14.jpg" alt=""></a>
                            ...
                            <div class="new-top-wrapper mb-50">
                                <div class="new-top-img">
                                    <a href="#"><img src="assets/img/product/book/16.jpg" alt=""></a>
                                    <div class="discount-book-cart">
                                        <a class="animate-left add-style-2" href="#" title="Add To Cart">
                                            <i class="ti-shopping-cart"></i>
                                        </a>
                                ...
                                <div class="new-top-content">
                                    <h4><a href="product-details.html">Fallen Light</a></h4>
                                    <span>Dr. KB Arif</span>
                                    <div class="product-price">
                                        <div class="old-price">
                                            <span>$49.00</span>
                ...
                <div class="col-lg-6 col-xl-6 col-md-12">
                    <div class="new-top ml-15">
                        ...
                        <div class="new-top-product">
                            <div class="new-top-wrapper mb-50">
                                <div class="new-top-img">
                                    <a href="#"><img src="assets/img/product/book/15.jpg" alt=""></a>
                                    <div class="discount-book-cart">
                                        <a class="animate-left add-style-2" href="#" title="Add To Cart">
                                            <i class="ti-shopping-cart"></i>
                                        </a>
                                ...
                                <div class="new-top-content">
                                    <h4><a href="product-details.html">Fly High</a></h4>
                                    <span>Dr. KB Arif</span>
                                    <div class="product-price">
                                        <div class="old-price">
                                            <span>$49.00</span>
                            ...
                            <div class="new-top-wrapper mb-50">
                                <div class="new-top-img">
                                    <a href="#"><img src="assets/img/product/book/17.jpg" alt=""></a>
                                    <div class="discount-book-cart">
                                        <a class="animate-left add-style-2" href="#" title="Add To Cart">
                                            <i class="ti-shopping-cart"></i>
                                        </a>
                                ...
                                <div class="new-top-content">
                                    <h4><a href="product-details.html">History of Moon</a></h4>
                                    <span>Dr. KB Arif</span>
                                    <div class="product-price">
                                        <div class="old-price">
                                            <span>$49.00</span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="blog-wrapper mb-40">
                        <div class="blog-img blog-hover mb-15">
                            <a href="blog-details-sidebar.html"><img src="assets/img/blog/1.jpg" alt=""></a>
                        </div>
                        <div class="blog-info">
                            <h4><a href="blog-details-sidebar.html">Bangla Academy Book fair.</a></h4>
                ...
                <div class="col-md-4">
                    <div class="blog-wrapper mb-40">
                        <div class="blog-img blog-hover mb-15">
                            <a href="blog-details-sidebar.html"><img src="assets/img/blog/2.jpg" alt=""></a>
                        </div>
                        <div class="blog-info">
                            <h4><a href="blog-details-sidebar.html">Bangla New Book Shop.</a></h4>
                            <span>February 13, 2017</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="blog-wrapper mb-40">
                        <div class="blog-img blog-hover mb-15">
                            <a href="blog-details-sidebar.html"><img src="assets/img/blog/3.jpg" alt=""></a>
                        </div>
                        <div class="blog-info">
                            <h4><a href="blog-details-sidebar.html">Latest Book Collection 2018.</a></h4>
                            <span>February 13, 2017</span>
                        </div>
                    </div>
                </div>
    ...
    <div class="subscribe bg-img ptb-80" style="background-image: url(assets/img/bg/2.jpg)">
        <div class="container">
            <div class="row">
